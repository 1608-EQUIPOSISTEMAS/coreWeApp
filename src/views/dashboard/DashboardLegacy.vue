...
// Dashboard anterior (demo CoreUI) — lo ven los roles que no son ADMIN.
// Los arreglos vacíos existen para que los v-for no logueen warnings.
      ...
      <CCol :md="12">
        <CCard class="mb-4">
          ...
          <CCardBody>
            ...
            <br />
            <CTable v-if="tableExample.length" align="middle" class="mb-0 border" hover responsive>
