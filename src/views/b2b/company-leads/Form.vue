      ...
      <div class="masthead-inner">
        <div class="masthead-brand">
          ...
          <div class="brand-text d-flex align-items-center gap-3">
            <div>
              <span class="brand-eyebrow">B2B · Empresa</span>
              <h1 class="brand-title">Lead Empresa</h1>
            </div>
          </div>
        </div>
    ...
    <main class="exec-body pb-5" v-if="loaded">
      <div class="exec-form-grid">
        ...
        <div class="col-left">
          ...
          <div class="exec-card exec-card--empresa mb-4">
            ...
            <div class="exec-card__body">
              <div class="row g-3"> 
                <div class="col-12">
                  <label class="exec-label">Intención de Negocio / Tipo Trato <span class="c-red">*</span></label>
                  <SearchSelect
                ...
                <div class="col-12">
                  <label class="exec-label">Nombre del Contacto (Persona) <span class="c-red">*</span></label>
                  <input
        ...
        <div class="col-right">
          ...
          <!-- Programa de Interés -->
          <div class="exec-card mb-4" v-if="showProgramSection">
            <div class="exec-card__header">
