  ...
  <div class="masthead-inner">
    <div class="masthead-brand">
      ...
      <div class="brand-text">
        <span class="brand-eyebrow" v-show="!toolbarCollapsed">Fundación</span>
        <h1 class="brand-title">
          <span v-if="!toolbarCollapsed">Leads Fundación</span>
...
const COL_GROUPS_KEY = 'crm_leads_fundacion_col_groups_v1'
...
const toolbarCollapsed = ref(localStorage.getItem('crm_leads_fundacion_toolbar_collapsed') === 'true')
watch(toolbarCollapsed, (val) => { localStorage.setItem('crm_leads_fundacion_toolbar_collapsed', val) })
